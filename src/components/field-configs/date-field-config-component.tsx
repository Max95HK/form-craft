...
import { cn, getInitialDate, parseDates } from "@/lib/utils";
    ...
    <>
      <FieldSet>
        ...
        <FieldGroup>
          ...
          <Field className="flex flex-col gap-2 text-foreground/80">
            <FieldLabel className="text-lg">Disabled Dates</FieldLabel>
                ...
                >
                  ...
                  {disabledDate ? (
                    <span className="text-foreground">
                      {format(disabledDate, defaultFormat)}
                    </span>
                  ) : (
            ...
            <Popover>
              ...
              <PopoverContent className="w-auto p-0">
                <Calendar
                  ...
                  selected={date}
                  disabled={parseDates(defaultFormat, disabledDates)}
                  required
                />
              </PopoverContent>
            </Popover>
